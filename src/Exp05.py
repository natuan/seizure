...
n_neurons = 50
n_epochs = 100
noise_stddev = None #0.1
hidden_activation = tf.nn.elu
scaler = MinMaxScaler(feature_range=(-10,10))
model_path = os.path.join(root_dir,"Exp05","neuron{}_epoch{}_elu.ckpt".format(n_neurons, n_epochs))
tf_log_dir = os.path.join(root_dir, "Exp05", "tf_logs")
...
plot_dir_path = os.path.join(root_dir, "Exp05", "plots")
...
weights_dir_path = os.path.join(root_dir, "Exp05", "plots_hidden_weights")

...
n_epochs = 1000
dropout_rate = 0.3
model_path = os.path.join(root_dir,"Exp04","neuron{}_epoch{}.ckpt".format(n_neurons, n_epochs))
tf_log_dir = os.path.join(root_dir, "Exp04", "tf_logs")
autoencoder = UnitAutoencoder("MyAutoencoder", n_inputs, n_neurons, dropout_rate=dropout_rate, tf_log_dir=tf_log_dir)

...
n_neurons = 10
n_epochs = 1000
model_path = os.path.join(root_dir,"Exp02","neuron{}_epoch{}.ckpt".format(n_neurons, n_epochs))
tf_log_dir = os.path.join(root_dir, "Exp02", "tf_logs")
autoencoder = UnitAutoencoder("MyAutoencoder", n_inputs, n_neurons, tf_log_dir = tf_log_dir)

...
model_path = os.path.join(root_dir,"Exp07","neuron{}_epoch{}_relu.ckpt".format(n_neurons, n_epochs))
tf_log_dir = os.path.join(root_dir, "Exp07", "tf_logs")
...
#feature_extractor.fit(X_test = None, n_epochs = n_epochs, model_path=model_path, tfdebug=False)
...
plot_dir_path = os.path.join(root_dir, "Exp07", "plots")
...
weights_dir_path = os.path.join(root_dir, "Exp07", "plots_hidden_weights")

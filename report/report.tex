...
\noindent
The approach proposed in this project was implemented in Python 3 using TensorFlow library, and its source code could be found in the following repository:
\begin{center}
\href{https://github.com/natuan/seizure.git}{\textit{https://github.com/natuan/seizure/tree/master/src}}.
\end{center}
...
\section{Conclusion}
\noindent
This work presented an approach to classifying brain activitiy signals in the data set provided by ~\cite{andrzejak2001indications} into volunteer classes related to epileptic seizure disease. The proposed method is motivated from the fact that despite Deep Neural Networks have been used for EED domains (including this one), and auto-encoders have been shown to work as well as DBN's building block (Restricted Boltzmann Machines) in helping deep networks be able to train, there was no previous work using auto-encoders for the data set of interest. The approach and results can be summarized as follows:
\begin{itemize}
